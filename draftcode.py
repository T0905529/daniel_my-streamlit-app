...
if (Current_Premium <= Cost_Threshold):
    st.write(
        f"**Recommendation:** You should use your own vehicle because the percent premium you are paying per mile is **${Current_Premium_Value:.2f}**, which is lower than the threshold cost per mile of **${New:.2f}**."
    )
else:
